...
exports.BasketItemsService = void 0;
const common_1 = require("@nestjs/common");
const sequelize_1 = require("@nestjs/sequelize");
const basketItems_model_1 = require("./models/basketItems.model");
let BasketItemsService = class BasketItemsService {
    constructor(basketItemsRepository) {
    ...
    async update(id, updateBasketItemsDto) {
        const builder = await this.basketItemsRepository.update(updateBasketItemsDto, {
            where: { id },
            returning: true,
        });
...
exports.BasketItemsService = BasketItemsService;
exports.BasketItemsService = BasketItemsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, sequelize_1.InjectModel)(basketItems_model_1.BasketItems)),
    __metadata("design:paramtypes", [Object])
], BasketItemsService);
//# sourceMappingURL=basketItems.service.js.map